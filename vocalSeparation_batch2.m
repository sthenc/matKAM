...
% NOTE : useful command to start matlab in shell > matlab -nodesktop -nodisplay
...
% directory = '/mnt/data/Fer/diplomski/test_data/govor_dom_muzika';
directory = '/mnt/data/Fer/diplomski/test_data2/vokali_glasniji_od_glazbe';
%directory = './data';
...
%output_dir = '/mnt/data/Fer/diplomski/test_data/govor_dom_muzika_output';
output_dir = '/mnt/data/Fer/diplomski/test_data2/vokali_glasniji_od_glazbe_output'; 
%Signal and STFT
